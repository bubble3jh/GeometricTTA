...
_C.CALM.LAMBDA_MI = 5.0          # H(Y) marginal entropy weight
_C.CALM.W_COV = 0.1              # off-diagonal logit correlation penalty
_C.CALM.W_I2T = 1.0              # I2T prototype alignment weight
_C.CALM.ALPHA_S = 2.0            # sigmoid sharpness for MAD-scaled weights
_C.CALM.USE_UNIFORM_I2T = True   # uniform vs soft-weight I2T
_C.CALM.BETA_MARG = 0.9          # EMA decay for running marginal
