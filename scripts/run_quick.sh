#!/usr/bin/env bash
# Quick validation run: 1000 samples per corruption (~1.5 min each).
# Use for development / relative comparison. Full run: NUM_EX -1.
set -e
...
echo "=== [2/4] BATCLIP/ours (ViT-B/16, fp32) ==="
python3 test_time.py \
